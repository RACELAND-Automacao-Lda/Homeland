import{i as t,s as e,n as o,l as i,k as n,_ as r,y as a,o as c,a as l,b as s,e as d,t as h,c as p}from"./broadlink-remote-card-a8bc8087.js";var u;const g=t`
    ...
    `;let b=u=class extends e{constructor(){super(...arguments),this.learningOn=!1,this.quickLearning=!1,this.learningLock=!1,this.buttonBeingLearned="none"}async showDialog(t){this._params=t,this.broadlinkInfo=this._params.broadlinkInfo,this.obj=this._params.obj,this.config=this.broadlinkInfo,this.show_animation=!1,this._show_sound_output=!1,this._show_inputs=!1,this._show_keypad=!1,this.show_animation_remote=!1,this.stateObj=this.obj,this.learningOn=!1,this.buttonBeingLearned=null,this.learningLock=!1}closeDialog(){this.learningOn=!1,this.buttonBeingLearned=null,this.learningLock=!1,this._params=void 0,o(this,"dialog-closed",{dialog:this.localName})}async firstUpdated(t){var e;super.firstUpdated(t),o(this,"config-changed",{config:this.config}),null===(e=document.getElementById("bar"))||void 0===e||e.click()}setConfig(t){if(!t)throw new Error(i("common.invalid_configuration"));t.test_gui&&n().setEditMode(!0)}shouldUpdate(t){return!!this.config&&r(this,t,!0)}static get disneyIcon(){return a`<svg version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
 ...
 `}static get amazonPrimeIcon(){return a`<svg version="1.1" id="Livello_1" class="prime" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
 ...
 `}static get daznIcon(){return a`<svg version="1.0" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
 ...
 `}static get tvoptic(){return a`<svg version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
 ...
 `}static get tvheadphone(){return a`
          <svg version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 567 171" style="enable-background:new 0 0 567 171;" xml:space="preserve">
          <style type="text/css">
          .st0{fill:var(--remote-text-color);}
          ...
          </svg>`}static get optic(){return a`<svg version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 567 171" style="enable-background:new 0 0 567 171;" xml:space="preserve">
          <style type="text/css">
          .st0{fill:var(--remote-text-color);}
          </style>
     ...
     `}static get arc(){return a`<svg version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 567 171" style="enable-background:new 0 0 567 171;" xml:space="preserve">
          <style type="text/css">
          .st0{fill:var(--remote-text-color);}
          </style>
          ...
          </svg>`}static get lineout(){return a`<svg version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          viewBox="0 0 567 171" style="enable-background:new 0 0 567 171;" xml:space="preserve">
          <style type="text/css">
          .st0{fill:var(--remote-text-color);}
          </style>
 ...
 `}static get iconMapping(){return{disney:this.disneyIcon,dazn:this.daznIcon,nowtv:this.nowTv}}render(){var t,e,o,n,r,c;if(this.config.show_warning||!this.config.entity)return this._showWarning(i("common.show_warning"));if(this.config.show_error)return this._showError(i("common.show_error"));if(!this._params)return a``;let l=0;if(null===(t=this.config)||void 0===t?void 0:t.all_devices)for(let t=0;t<(null===(o=null===(e=this.config)||void 0===e?void 0:e.all_devices)||void 0===o?void 0:o.length);t++)(null===(n=this.config)||void 0===n?void 0:n.all_devices[t].mac)===(null===(r=this.config)||void 0===r?void 0:r.entity)&&(l=t);const s=null===(c=this.config)||void 0===c?void 0:c.all_devices[l].presets;for(const[t,e]of Object.entries(s));return this.config.preset&&(this.remoteType=this.config.all_devices[l].presets[this.config.preset].type),this.colorButtons="enable"===this.config.color_buttons,this.borderWidth=this.config.dimensions&&this.config.dimensions.border_width?this.config.dimensions.border_width:"1px",this.scale=this.config.dimensions&&this.config.dimensions.scale?this.config.dimensions.scale:1,this.scale&&(this.remoteWidth=Math.round(260*this.scale)+"px"),this.backgroundColor=this.config.colors&&this.config.colors.background?this.config.colors.background:"#111111",this.borderColor=this.config.colors&&this.config.colors.border?this.config.colors.border:"#111111",this.buttonColor=this.config.colors&&this.config.colors.buttons?this.config.colors.buttons:"var(--raquel-dark-2)",this.textColor=this.config.colors&&this.config.colors.texts?this.config.colors.texts:"white",a`
    <ha-dialog
          open
          scrimClickAction
          hideActions
        ...
        <div class="content">
          ...
          ${"tv"===this.remoteType?this._renderTvRemote():"ac"===this.remoteType?this._renderAcRemote():a``}
          </div>
        </div>
    </ha-dialog>
    `}_renderAcRemote(){return a`
      <div class="row">
              <button class="learning-button" @click=${()=>this._handleAction("LearningMode")}>ENTER LEARNING MODE</button>
        </div>
    <div id="sep"></div>
    <div class=${c({"learning-on":!0===this.learningOn,page:!0})}
            id="acCardRemote"
   ...
   <div class="grid-container-ac">
    <div class="first-rows-ac">
        <button id="power-off" class="btn_source ripple ${c({"learning-on-button":"power_off"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("power_off")}><ha-icon style="width: 70%;" icon="mdi:power-off"/></button>
        <div class="text">Power Off</div>
        <button class="btn_source ripple ${c({"learning-on-button":"modes"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("modes")}><ha-icon style="width: 70%;" icon="mdi:gesture-tap-button"/></button>
        <div class="text">Modes</div>
        <button class="btn_source ripple ${c({"learning-on-button":"swing"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("swing")}><ha-icon style="width: 70%;" icon="mdi:sync"/></button>
        <div class="text">Swing</div>
    </div>
    <div class="first-rows-ac">
        <button id="power-on" class="btn_source ripple ${c({"learning-on-button":"power_on"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("power_on")}><ha-icon style="width: 70%;" icon="mdi:power"/></button>
        <div class="text">Power On</div>
        <button class="btn_source ripple ${c({"learning-on-button":"fan"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("fan")}><ha-icon style="width: 70%;" icon="mdi:fan"/></button>
        <div class="text">Fan</div>
         <button class="btn_source ripple ${c({"learning-on-button":"sleep"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("sleep")}><ha-icon style="width: 70%;" icon="mdi:power-sleep"/></button>
        <div class="text">Sleep</div>
    </div>
        <div id="temp-btn">
        <button class="btn_temp ripple ${c({"learning-on-button":"temp_plus"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("temp_plus")}><ha-icon style="width: 70%;" icon="mdi:thermometer-plus"/></button>
        <div class="text"> ºC </div>
        <button class="btn_temp ripple ${c({"learning-on-button":"temp_minus"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("temp_minus")}><ha-icon style="width: 70%;" icon="mdi:thermometer-minus"/></button>
        </div>
    </div>
    <div id="sep"></div>
    <div class="grid-container-ac">
        <div class="second-row-ac">
            <button class="btn_source ripple ${c({"learning-on-button":"speed_1"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("speed_1")}><ha-icon style="width: 70%;" icon="mdi:fan-speed-1"/></button>
                <div class="text">Speed 1</div>
        </div>
        <div class="second-row-ac">
            <button class="btn_source ripple ${c({"learning-on-button":"speed_2"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("speed_2")}><ha-icon style="width: 70%;" icon="mdi:fan-speed-2"/></button>
            <div class="text">Speed 2</div>
        </div>
        <div class="second-row-ac">
            <button class="btn_source ripple ${c({"learning-on-button":"speed_3"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("speed_3")}><ha-icon style="width: 70%;" icon="mdi:fan-speed-3"/></button>
            <div class="text">Speed 3</div>
        </div>
    </div>
    <div class="grid-container-ac">
        <div class="second-row-ac">
            <button class="btn_source ripple ${c({"learning-on-button":"timer_on"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("timer_on")}><ha-icon style="width: 70%;" icon="mdi:timer"/></button>
                <div class="text">Timer On</div>
        </div>
        <div class="second-row-ac">
            <button class="btn_source ripple ${c({"learning-on-button":"timer_off"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("timer_off")}><ha-icon style="width: 70%;" icon="mdi:timer-off"/></button>
            <div class="text">Timer Off</div>
        </div>
        <div class="second-row-ac">
            <button class="btn_source ripple ${c({"learning-on-button":"power_save"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("power_save")}><ha-icon style="width: 70%;" icon="mdi:power-plug"/></button>
    ...
    <div class="grid-container-ac">
        ...
        <div class="second-row-ac">
            <button class="btn_source ripple ${c({"learning-on-button":"silent_mode"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("silent_mode")}><ha-icon style="width: 70%;" icon="mdi:butterfly"/></button>
    ...
    `}_renderTvRemote(){return a`
            <div class="row">
              <button class="learning-button" @click=${()=>this._handleAction("LearningMode")}>ENTER LEARNING MODE</button>
            </div>
            <div class="sep"></div>
            <div class=${c({"learning-on":!0===this.learningOn,card:!0})}
            id="tvCardRemote"
            >
                <div class="page" style="--remote-button-color: ${this.buttonColor}; --remote-text-color: ${this.textColor}; --remote-color: ${this.backgroundColor}; --remotewidth: ${this.remoteWidth};  --main-border-color: ${this.borderColor}; --main-border-width: ${this.borderWidth}">
                    <div class="grid-container-power"  style="--remotewidth: ${this.remoteWidth}">
                        <button class="btn-flat flat-high ripple ${c({"learning-on-button":"ChannelList"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("ChannelList")}><ha-icon icon="mdi:format-list-numbered"/></button>
                        <button class="btn ripple ${c({"learning-on-button":"Power"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("Power")}><ha-icon icon="mdi:power" style="color: red;"/></button>
                        <button class="btn-flat flat-high ripple" @click=${this._showAnimation}>123</button>
                    </div>
                    <div class=${c({buttons:!0===this.show_animation_remote})}>
                        ${this._show_sound_output?a`
        <!-- ################################# SOUND ################################# -->
                            <div id="spacer">
                                <div class="grid-container-sound">
                                    ...
                                    ${this._show_text?a`
                                        ...
                                        <button class="btn_sound_off tv bnt_sound_text_width ripple overlay ${c({"learning-on-button":"TV Speaker"===this.buttonBeingLearned})}"
                                        style="margin-left: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("TV Speaker")}>TV Speaker</button>
                                        <button class="btn_sound_off tv-opt bnt_sound_text_width ripple overlay ${c({"learning-on-button":"TV External Speaker"===this.buttonBeingLearned})}" style="margin-right: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("TV External Speaker")}>TV + Optic</button>
                                        <button class="btn_sound_off tv-phone bnt_sound_text_width ripple overlay ${c({"learning-on-button":"TV Speaker Headphone"===this.buttonBeingLearned})}" style="margin-left: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("TV Speaker Headphone")}>TV + H-Phone</button>
                                        <button class="btn_sound_off opt bnt_sound_text_width ripple overlay ${c({"learning-on-button":"External Optical"===this.buttonBeingLearned})}" style="margin-right: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("External Optical")}>Optical</button>
                                        <button class="btn_sound_off hdmi bnt_sound_text_width ripple overlay ${c({"learning-on-button":"HDMI"===this.buttonBeingLearned})}" style="margin-left: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("HDMI")}>HDMI</button>
                                        <button class="btn_sound_off line bnt_sound_text_width ripple overlay ${c({"learning-on-button":"Lineout"===this.buttonBeingLearned})}" style="margin-right: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("Lineout")}>Lineout</button>
                                        <button class="btn_sound_off phone bnt_sound_text_width ripple overlay ${c({"learning-on-button":"Headphone"===this.buttonBeingLearned})}" style="margin-left: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("Headphone")}>HeadPhone</button>
                                        <button class="btn_sound_off bluetooth bnt_sound_text_width ripple overlay ${c({"learning-on-button":"Bluetooth Soundbar"===this.buttonBeingLearned})}" style="margin-right: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("Bluetooth Soundbar")}>Bluetooth</button>
                                            `:a`
                                        ...
                                        <button class="btn_sound_off tv bnt_sound_text_width ripple overlay ${c({"learning-on-button":"TV Speaker"===this.buttonBeingLearned})}" style="margin-left: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("TV Speaker")}}><ha-icon class="icon_source" icon="mdi:television-classic"></button>
                                        <button class="btn_sound_off tv-opt bnt_sound_text_width ripple overlay ${c({"learning-on-button":"TV External Speaker"===this.buttonBeingLearned})}" style="margin-right: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("TV External Speaker")}>${u.tvoptic}</button>
                                        <button class="btn_sound_off tv-phone bnt_sound_text_width ripple overlay ${c({"learning-on-button":"TV Speaker Headphone"===this.buttonBeingLearned})}" style="margin-left: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("TV Speaker Headphone")}>${u.tvheadphone}</button>
                                        <button class="btn_sound_off opt bnt_sound_text_width ripple overlay ${c({"learning-on-button":"External Optical"===this.buttonBeingLearned})}" style="margin-right: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("External Optical")}>${u.optic}</button>
                                        <button class="btn_sound_off hdmi bnt_sound_text_width ripple overlay ${c({"learning-on-button":"HDMI"===this.buttonBeingLearned})}" style="margin-left: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("HDMI")}>${u.arc}</button>
                                        <button class="btn_sound_off line bnt_sound_text_width ripple overlay ${c({"learning-on-button":"Lineout"===this.buttonBeingLearned})}" style="margin-right: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("Lineout")}>${u.lineout}</button>
                                        <button class="btn_sound_off phone bnt_sound_text_width ripple overlay ${c({"learning-on-button":"Headphone"===this.buttonBeingLearned})}" style="margin-left: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("Headphone")}><ha-icon class="icon_source" icon="mdi:headphones"></button>
                                        <button class="btn_sound_off bluetooth bnt_sound_text_width ripple overlay ${c({"learning-on-button":"Bluetooth Soundbar"===this.buttonBeingLearned})}" style="margin-right: calc(var(--remotewidth) / 10);" @click=${()=>this._handleAction("Bluetooth Soundbar")}><ha-icon class="icon_source" icon="mdi:bluetooth"></button>
                                        `}
                                </div>
                            </div>
        <!-- ################################# SOUND END ################################# -->
        ...
        <!-- ################################ keypad ################################## -->
                                <div class="grid-container-keypad">
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"1"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("1")}>1</button>
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"2"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("2")}>2</button>
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"3"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("3")}>3</button>
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"4"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("4")}>4</button>
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"5"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("5")}>5</button>
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"6"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("6")}>6</button>
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"7"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("7")}>7</button>
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"8"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("8")}>8</button>
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"9"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("9")}>9</button>
                                    <button class="btn-keypad"></button>
                                    <button class="btn-keypad ripple ${c({"learning-on-button":"0"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("0")}>0</button>
                                    <button class="btn-keypad"></button>
                            </div>
                            <!-- ################################# keypad end ############################## -->
                            `:a`
                            <!-- ################################# DIRECTION PAD ################################# -->
                            <div class="grid-container-cursor${c({"expand-animation":!0===this.show_animation})}">
                                <div class="shape">
                            ...
                            <button class="btn ripple item_sound ${c({"learning-on-button":"SoundControl"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("SoundControl")}><ha-icon icon="mdi:speaker"/></button>
                            <button class="btn ripple item_up ${c({"learning-on-button":"UP"===this.buttonBeingLearned})}" style="background-color: transparent;" @click=${()=>this._handleAction("UP")}><ha-icon icon="mdi:chevron-up"/></button>
                            <button class="btn ripple item_input ${c({"learning-on-button":"Source"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("Source")}><ha-icon icon="mdi:import"/></button>
                            <button class="btn ripple item_2_sx ${c({"learning-on-button":"LEFT"===this.buttonBeingLearned})}" style="background-color: transparent;" @click=${()=>this._handleAction("LEFT")}><ha-icon icon="mdi:chevron-left"/></button>
                            <button class="btn bnt_ok ripple item_2_c ${c({"learning-on-button":"ENTER"===this.buttonBeingLearned})}" style="border: solid 2px ${this.backgroundColor}"  @click=${()=>this._handleAction("ENTER")}>OK</button>
                            <button class="btn ripple item_right ${c({"learning-on-button":"RIGHT"===this.buttonBeingLearned})}" style="background-color: transparent;" @click=${()=>this._handleAction("RIGHT")}><ha-icon icon="mdi:chevron-right"/></button>
                            <button class="btn ripple item_back ${c({"learning-on-button":"BACK"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("BACK")}><ha-icon icon="mdi:undo-variant"/></button>
                            <button class="btn ripple item_down ${c({"learning-on-button":"DOWN"===this.buttonBeingLearned})}" style="background-color: transparent;" @click=${()=>this._handleAction("DOWN")}><ha-icon icon="mdi:chevron-down"/></button>
                            <button class="btn ripple item_exit ${c({"learning-on-button":"EXIT"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("EXIT")}>EXIT</button>
                        </div>
                        <!-- ################################# DIRECTION PAD END ################################# -->
                        `}
                        </div>
        ...
        <!-- ################################# SOURCE BUTTONS ################################# -->
                          <div class="grid-container-source">
                              <button class="btn_source ripple ${c({"learning-on-button":"Netflix"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("Netflix")}><ha-icon style="width: 70%;" icon="mdi:netflix"/></button>
                              <button class="btn_source ripple ${c({"learning-on-button":"Prime Video"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("Prime Video")}>${u.amazonPrimeIcon}</button>
                              <button class="btn_source ripple ${c({"learning-on-button":"Disney+"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("Disney+")}>${u.disneyIcon}</button>
                              <button class="btn_source ripple ${c({"learning-on-button":"DAZN"===this.buttonBeingLearned})}" @click=${()=>this._handleAction("DAZN")}>${u.daznIcon}</button>
                          </div>
        <!-- ################################# SOURCE BUTTONS END ################################# -->

        <!-- ################################# COLORED BUTTONS ################################# -->
                        <div class="grid-container-color_btn">
                            <button class="btn-color ripple ${c({"learning-on-button":"RED"===this.buttonBeingLearned})}" style="background-color: red; height: calc(var(--remotewidth) / 12);" @click=${()=>this._handleAction("RED")}></button>
                            <button class="btn-color ripple ${c({"learning-on-button":"GREEN"===this.buttonBeingLearned})}" style="background-color: green; height: calc(var(--remotewidth) / 12);" @click=${()=>this._handleAction("GREEN")}></button>
                            <button class="btn-color ripple ${c({"learning-on-button":"YELLOW"===this.buttonBeingLearned})}" style="background-color: yellow; height: calc(var(--remotewidth) / 12);" @click=${()=>this._handleAction("YELLOW")}></button>
                            <button class="btn-color ripple ${c({"learning-on-button":"BLUE"===this.buttonBeingLearned})}" style="background-color: blue; height: calc(var(--remotewidth) / 12);" @click=${()=>this._handleAction("BLUE")}></button>
                        </div>
        <!-- ################################# COLORED BUTTONS END ################################# -->

                        <div class="grid-container-volume-channel-control" >
                            <button class="btn ripple ${c({"learning-on-button":"volume_up"===this.buttonBeingLearned})}"  style="border-radius: 50% 50% 0px 0px; margin: 0px auto 0px auto; height: 100%;" @click=${()=>this._handleAction("volume_up")}><ha-icon icon="mdi:plus"/></button>
                            <button class="btn-flat flat-high ripple ${c({"learning-on-button":"HOME"===this.buttonBeingLearned})}" style="margin-top: 0px; height: 50%;" @click=${()=>this._handleAction("HOME")}><ha-icon icon="mdi:home"></button>
                            <button class="btn ripple ${c({"learning-on-button":"CHANNELUP"===this.buttonBeingLearned})}" style="border-radius: 50% 50% 0px 0px; margin: 0px auto 0px auto; height: 100%;" @click=${()=>this._handleAction("CHANNELUP")}><ha-icon icon="mdi:chevron-up"/></button>
                            <button class="btn ${c({"learning-on-button":"VOLUMEOFF"===this.buttonBeingLearned})}" style="border-radius: 0px; cursor: default; margin: 0px auto 0px auto; height: 100%;" @click=${()=>this._handleAction("VOLUMEOFF")}><ha-icon icon="mdi:volume-off"/></button>
                            <button class="btn ripple ${c({"learning-on-button":"MUTE"===this.buttonBeingLearned})}" style="color: ${this.textColor}; height: 100%;" @click=${()=>this._handleAction("MUTE")}><span class=""><ha-icon icon="mdi:volume-mute"></span></button>
                            <button class="btn ${c({"learning-on-button":"PARKING"===this.buttonBeingLearned})}" style="border-radius: 0px; cursor: default; margin: 0px auto 0px auto; height: 100%;" @click=${()=>this._handleAction("PARKING")}><ha-icon icon="mdi:parking"/></button>
                            <button class="btn ripple ${c({"learning-on-button":"volume_down"===this.buttonBeingLearned})}" style="border-radius: 0px 0px 50% 50%;  margin: 0px auto 0px auto; height: 100%;" @click=${()=>this._handleAction("volume_down")}><ha-icon icon="mdi:minus"/></button>
                            <button class="btn-flat flat-high ripple ${c({"learning-on-button":"INFO"===this.buttonBeingLearned})}" style="margin-bottom: 0px; height: 50%;" @click=${()=>this._handleAction("INFO")}><ha-icon icon="mdi:information-variant"/></button>
                            <button class="btn ripple ${c({"learning-on-button":"CHANNELDOWN"===this.buttonBeingLearned})}" style="border-radius: 0px 0px 50% 50%;  margin: 0px auto 0px auto; height: 100%;"  @click=${()=>this._handleAction("CHANNELDOWN")}><ha-icon icon="mdi:chevron-down"/></button>
                        </div>

        <!-- ################################# MEDIA CONTROL ################################# -->
                          <div class="grid-container-media-control" >
                              <button class="btn-flat flat-low ripple ${c({"learning-on-button":"play"===this.buttonBeingLearned})}"  @click=${()=>this._handleAction("play")}><ha-icon icon="mdi:play"/></button>
                              <button class="btn-flat flat-low ripple ${c({"learning-on-button":"pause"===this.buttonBeingLearned})}"  @click=${()=>this._handleAction("pause")}><ha-icon icon="mdi:pause"/></button>
                              <button class="btn-flat flat-low ripple ${c({"learning-on-button":"stop"===this.buttonBeingLearned})}"  @click=${()=>this._handleAction("stop")}><ha-icon icon="mdi:stop"/></button>
                              <button class="btn-flat flat-low ripple ${c({"learning-on-button":"rewind"===this.buttonBeingLearned})}"  @click=${()=>this._handleAction("rewind")}><ha-icon icon="mdi:skip-backward"/></button>
                              <button class="btn-flat flat-low ripple ${c({"learning-on-button":"Record"===this.buttonBeingLearned})}" style="color: red;" @click=${()=>this._handleAction("Record")}><ha-icon icon="mdi:record"/></button>
                              <button class="btn-flat flat-low ripple ${c({"learning-on-button":"fastForward"===this.buttonBeingLearned})}"  @click=${()=>this._handleAction("fastForward")}><ha-icon icon="mdi:skip-forward"/></button>
                          </div>
        <!-- ################################# MEDIA CONTROL END ################################# -->
                          </div>
                        </div>
      ...
      `}_handleAction(t){var e,o,i,n,r;let a=0;if(null===(e=this.config)||void 0===e?void 0:e.all_devices)for(let t=0;t<(null===(i=null===(o=this.config)||void 0===o?void 0:o.all_devices)||void 0===i?void 0:i.length);t++)(null===(n=this.config)||void 0===n?void 0:n.all_devices[t].mac)===(null===(r=this.config)||void 0===r?void 0:r.entity)&&(a=t);if(this.config.preset&&(this.remoteType=this.config.all_devices[a].presets[this.config.preset].type),this.hass&&this.config){if("LearningMode"===t)return this.quickLearning=!0,void(this.learningOn=!this.learningOn);if(!0===this.learningOn&&(this.buttonBeingLearned=t),!0===this.learningOn&&this.config.preset){this.learningLock=!0;const e=this.config.entity;l(this.hass,e,this.config.preset,this.config.entity_id,t).then((t=>{t.sucess&&(this.learningLock=!1,this.buttonBeingLearned="none",this.quickLearning&&(this.quickLearning=!1,this.learningOn=!1))}))}else!1===this.learningOn&&"LearningMode"!==t&&this.hass.callService("broadlink","send_command",{button_name:t,entity_id:this.config.entity_id})}}_showWarning(t){return a`
      <hui-warning>${t}</hui-warning>
    `}_showAnimation(){this._show_keypad=!this._show_keypad,this.show_animation=!0}getCardSize(){return 15}static getIcon(t){return Object.keys(this.iconMapping).includes(t)?this.iconMapping[t]:a`<ha-icon style="height: 70%; width: 70%;" icon="${t}"/>`}_showError(t){const e=document.createElement("hui-error-card");return e.setConfig({type:"error",error:t,origConfig:this.config}),a`
      ${e}
    `}static get styles(){return[g,t`
        ha-header-bar {
    ...
    `]}};s([d({attribute:!1})],b.prototype,"hass",void 0),s([d({attribute:!1})],b.prototype,"learningOn",void 0),s([d({attribute:!1})],b.prototype,"quickLearning",void 0),s([d({attribute:!1})],b.prototype,"learningLock",void 0),s([d({attribute:!1})],b.prototype,"buttonBeingLearned",void 0),s([h()],b.prototype,"config",void 0),s([h()],b.prototype,"_params",void 0),s([h()],b.prototype,"broadlinkInfo",void 0),s([h()],b.prototype,"obj",void 0),s([h()],b.prototype,"remoteType",void 0),s([d({attribute:!1})],b.prototype,"stateObj",void 0),s([d({attribute:!1})],b.prototype,"show_animation",void 0),s([d({attribute:!1})],b.prototype,"show_animation_remote",void 0),s([d({attribute:!1})],b.prototype,"_show_inputs",void 0),s([d({attribute:!1})],b.prototype,"_show_sound_output",void 0),s([d({attribute:!1})],b.prototype,"_show_text",void 0),s([d({attribute:!1})],b.prototype,"_show_keypad",void 0),s([h()],b.prototype,"colorButtons",void 0),s([h()],b.prototype,"borderWidth",void 0),s([h()],b.prototype,"remoteWidth",void 0),s([h()],b.prototype,"backgroundColor",void 0),s([h()],b.prototype,"borderColor",void 0),s([h()],b.prototype,"buttonColor",void 0),s([h()],b.prototype,"textColor",void 0),s([h()],b.prototype,"scale",void 0),b=u=s([p("remote-card-dialog")],b);export{b as HuiMoreInfoBroadlink,g as haStyleDialog};
