"""Support for Raver sensors."""
from __future__ import annotations

from datetime import datetime
from typing import Any

from .haraver import const as hc, sensor as raver_sensor, status_sensor
...
# A Raver sensor type may be mapped to either a device class or an icon, not both
...
async def async_setup_entry(
    ...
    """Set up Raver sensor dynamically through discovery."""

    @callback
    def async_discover(
        raver_entity: HARaverEntity, discovery_hash: DiscoveryHashType
    ) -> None:
        """Discover and add a Raver sensor."""
        async_add_entities(
            [
                RaverSensor(
    ...
    hass.data[
        ...
        hass,
        RAVER_DISCOVERY_ENTITY_NEW.format(sensor.DOMAIN),
        async_discover,
    )


class RaverSensor(RaverAvailability, RaverDiscoveryUpdate, SensorEntity):
    """Representation of a Raver sensor."""

    _raver_entity: raver_sensor.RaverSensor

    def __init__(self, **kwds: Any) -> None:
        """Initialize the Raver sensor."""
    ...
    async def async_added_to_hass(self) -> None:
        ...
        self._raver_entity.set_on_state_callback(self.sensor_state_updated)
    ...
    def entity_category(self) -> EntityCategory | None:
        ...
        if self._raver_entity.quantity in status_sensor.SENSORS:
    ...
    def entity_registry_enabled_default(self) -> bool:
        ...
        if self._raver_entity.quantity in (
            hc.SENSOR_STATUS_IP,
            hc.SENSOR_STATUS_RSSI,
            hc.SENSOR_STATUS_SIGNAL,
    ...
    def native_unit_of_measurement(self) -> str | None:
        ...
        return SENSOR_UNIT_MAP.get(self._raver_entity.unit, self._raver_entity.unit)
