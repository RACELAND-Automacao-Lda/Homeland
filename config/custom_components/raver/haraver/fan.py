...
class RaverFanConfig(RaverAvailabilityConfig, RaverEntityConfig):
    """Raver fan configuation."""
    ...
    @classmethod
    def from_discovery_message(cls, config: dict, platform: str) -> RaverFanConfig:
...
class RaverFan(RaverAvailability, RaverEntity):
