...
class RaverShutterConfig(RaverAvailabilityConfig, RaverEntityConfig):
    """Raver shutter configuation."""
...
class RaverShutter(RaverAvailability, RaverEntity):
    """Representation of a Raver shutter."""

    _cfg: RaverShutterConfig
