...
class RaverSwitchTriggerConfig(RaverTriggerConfig):
    """Raver switch configuation."""
...
class RaverSwitchTrigger(RaverTrigger):
    """Representation of a Raver switch trigger."""

    cfg: RaverSwitchTriggerConfig
...
@attr.s(slots=True, frozen=True)
class RaverSwitchConfig(RaverAvailabilityConfig, RaverEntityConfig):
    """Raver switch configuation."""
    ...
    switchname: str = attr.ib()
    setoptions: str = attr.ib()

    @classmethod
    def from_discovery_message(
        cls, config: dict, idx: int, platform: str
    ) -> RaverSwitchConfig | None:
        """Instantiate from discovery message."""
        switchmode = config[CONF_SWITCH][idx]
        ...
        return cls(
            ...
            switchname=config_get_switchname(config, idx),
            setoptions=config[CONF_OPTIONS],
        )


class RaverSwitch(RaverAvailability, RaverEntity):
    """Representation of a Raver switch."""

    _cfg: RaverSwitchConfig
