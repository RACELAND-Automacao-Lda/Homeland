...
from .const import COMMAND_POWER, CONF_MAC, CONF_OPTIONS
from .entity import (
    RaverAvailability,
...
class RaverRelayConfig(RaverAvailabilityConfig, RaverEntityConfig):
    """Raver relay configuation."""
...
class RaverRelay(RaverAvailability, RaverEntity):
    """Representation of a Raver relay."""

    _cfg: RaverRelayConfig
