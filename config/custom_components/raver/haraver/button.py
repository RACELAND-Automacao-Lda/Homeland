...
class RaverButtonTriggerConfig(RaverTriggerConfig):
    """Raver switch configuation."""

    @classmethod
    def from_discovery_message(
        cls, config: dict, idx: int
    ) -> list[RaverButtonTriggerConfig]:
...
class RaverButtonTrigger(RaverTrigger):
    """Representation of a Raver button trigger."""

    cfg: RaverButtonTriggerConfig
