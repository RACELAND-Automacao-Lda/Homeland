...
class RaverDeviceStatusConfig(RaverAvailabilityConfig, RaverEntityConfig):
    ...
    @classmethod
    def from_discovery_message(cls, config: dict) -> RaverDeviceStatusConfig:
...
class RaverDeviceStatus(RaverAvailability, RaverEntity):
    """Raver device status."""

    _cfg: RaverDeviceStatusConfig
