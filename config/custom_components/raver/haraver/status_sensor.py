...
from .sensor import RaverBaseSensorConfig
from .utils import (
...
# 14:45:37 MQT: raver_B94927/tele/HASS_STATE = {
#  "Version":"9.0.0.1(raver)",               stat/STATUS2:"StatusFWR"."Version"
...
#  "Hostname":"raver_B94927",                stat/STATUS5:"StatusNET":"Hostname"
...
class RaverStatusSensorConfig(RaverBaseSensorConfig):
...
class RaverStatusSensor(RaverAvailability, RaverEntity):
    """Raver Status sensors."""

    _cfg: RaverStatusSensorConfig
